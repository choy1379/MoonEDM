...
var DJComponent = (function () {
    ...
    DJComponent.prototype.ngOnInit = function () {
        ...
        this.router.params.subscribe(function (params) {
            ...
            _this.http.post('https://still-gorge-46596.herokuapp.com/searchDJ', params, { headers: headers }).subscribe(function (res) {
                _this.loading = false;
    ...
    DJComponent.prototype.imgClick = function (res) {
        ...
        this.http.post('https://still-gorge-46596.herokuapp.com/searchPlaylist', playList, { headers: headers }).subscribe(function (res) {
